...
public class SessionalsActivity extends AppCompatActivity {
    ...
    private class DownloadTask extends AsyncTask<String,Void,String> {
        ...
        protected String doInBackground (String... urls){
            ...
            try{
                ...
                writer.write("class="+text+"&rollno="+rollno+"&Button1=Submit");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Sessionals");
        setContentView(R.layout.activity_sessionals);
        Intent intent=getIntent();
        text=intent.getStringExtra("text");
        rollno=intent.getStringExtra("rollno");
        SessionalsActivity.DownloadTask task = new DownloadTask();
        task.execute("http://evaluation.mec.ac.in/sessional-individual-student.php");
        //Log.i("Contents:",result);
        pro=(ProgressBar) findViewById(R.id.atten_progressBar);

        web = (WebView)findViewById(R.id.sess_webview);
